...
<head>
  ...
  <title>HDT Cinema | Manager</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>Cinema Manager</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="treeview">
          <a href="index.php">
            <i class="fa fa-home"></i> <span>Danh sách phim</span>
        ...
        <!-- <li class="treeview">
          <a href="add_show.php">
            <i class="fa fa-ticket"></i> <span>Thêm giờ chiếu</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
        ...
        <li class="treeview">
          <a href="details.php">
            <i class="fa fa-film"></i> <span>Thông tin tài khoản</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
