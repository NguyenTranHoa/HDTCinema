...
<div id="mainContainer" class="row large-centered">
  ...
  <dl class="mercDetails">
    ...
    <dt>Debit Card</dt> 		<dd><?php echo  $_SESSION['number'];?></%></dd>
  </dl>
  <hr class="divider"> -->
...
<h6 class="form-heading">Thanh toán</h6>
<p class="form-subheading">Mã OTP sẽ gửi vào số điện thoại bạn đăng kí tài khoản ngân hàng</p>
...
<label>&nbsp;</label><button class="expanded button next" onClick="ValidateForm()">Thanh toán</button>
</div>
</div>
<div class="text-right resendBtn requestOTP"><a class="request-link" href="javascript:void(0)">Gửi lại OTP</a></div>
<p>


<a class="tryAgain" href="index.php">Trở về trang chủ</a> 
</p>
</fieldset>
